...
public class SmartSpeakerTest {
    ...
    @Test
    public void testConstructor() { //FEITO
    ...
    @Test
    public void testGetVolume() {   //FEITO
    ...
    @Test
    public void testSetVolume() {   //FEITO
        SmartSpeaker smartSpe1 = new SmartSpeaker("s1", "RUM", 5);
        smartSpe1.volumeUp();
        smartSpe1.volumeUp();
    ...
    @Test
    public void testGetChannel() {  //FEITO
        SmartSpeaker smartSpe1 = new SmartSpeaker("s1", "RUM", 5);
    ...
    @Test
    public void testSetChannel() {  //FEITO
